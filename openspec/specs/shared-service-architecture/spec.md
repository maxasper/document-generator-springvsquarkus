# shared-service-architecture Specification

## Purpose
Define the repository-level architecture boundary that keeps Spring Boot and Quarkus on a shared pure-Java core with runtime-local adapters.
## Requirements
