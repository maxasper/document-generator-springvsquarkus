# runtime-contract-verification Specification

## Purpose
Define the documented verification flows and shared HTTP contract suite that keep Spring Boot and Quarkus behavior aligned in both `in-memory` and PostgreSQL-backed modes.
