...
- **THEN** the repository guide links to dedicated documents for runtime verification, JVM runtime comparison, native-image comparison, and manual JVM container inspection
